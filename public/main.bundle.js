...
module.exports = "<!DOCTYPE HTML>\n<head>\n<meta charset=\"utf-8\">\n<meta name=\"description\" content=\"Official website for Light of Knowledge Academy. Learn more now!\"/>\n<title>Register</title>\n</head>\n<h2 class=\"page-header\">Register</h2>\n<div id=\"register-box\">\n<form (submit)=\"onRegisterSubmit()\">\n\t<div class=\"form-group\">\n\t\t<label>Name</label>\n\t\t<input type=\"text\" [(ngModel)]=\"name\" name=\"name\" class=\"form-control\" placeholder=\"Enter full name\" style=\"width: 600px;\">\n\t</div>\n\t<div class=\"form-group\">\n\t\t<label>Username</label>\n\t\t<input type=\"text\" [(ngModel)]=\"username\" name=\"username\" class=\"form-control\" placeholder=\"Enter username (4-20 characters)\" style=\"width: 600px;\">\n\t</div>\n\t<div class=\"form-group\">\n\t\t<label>Email</label>\n\t\t<input type=\"text\" [(ngModel)]=\"email\" name=\"email\" class=\"form-control\" placeholder=\"Enter email\" style=\"width: 600px;\">\n\t</div>\n\t<div class=\"form-group\">\n\t\t<label>Password</label>\n\t\t<input type=\"password\" [(ngModel)]=\"password\" name=\"password\" class=\"form-control\" placeholder=\"Enter password (6-20 characters)\" style=\"width: 600px;\">\n\t</div>\n\n\t<input type=\"submit\" class=\"btn btn-primary\" value=\"Create Account\">\n</form>\n</div>\n<br><br><br><br>\n<!--style=\"position: absolute; bottom:0%; right: 0%;\"-->\n<div class =\"btn-group btn-group-justified\">\n\t<a class=\"btn btn-default\" target=\"_top\" [routerLink]=\"['/after-school']\">After School</a>\n\t<a class=\"btn btn-default\" target=\"_top\" [routerLink]=\"['/english-writing']\">Engish Writng</a>\n\t<a class=\"btn btn-default\" target=\"_top\" [routerLink]=\"['/math']\">Math</a>\n\t<a class=\"btn btn-default\" target=\"_top\" [routerLink]=\"['/enrichment-programs']\">Enrichment Programs</a>\n\t<a class=\"btn btn-default\" target=\"_top\" [routerLink]=\"['/join']\">Join Our Team Today!</a>\n</div>\n<br>\n"
